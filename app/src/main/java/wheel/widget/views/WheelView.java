...
public class WheelView extends View {
    ...
    private static final int[] SHADOWS_COLORS = new int[] {0xaaf5f5f5, 0x8af5f5f5, 0x33f5f5f5};
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int offsets = (int) (getItemHeight() / 10 * 3);
        canvas.drawLine(0, center - offsets, getWidth(), center - offsets, paint);
        canvas.drawLine(0, center + offsets, getWidth(), center + offsets, paint);
    }
