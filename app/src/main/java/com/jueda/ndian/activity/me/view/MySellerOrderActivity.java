...
import com.jueda.ndian.activity.me.adapter.MySellerOrderAdapter;
import com.jueda.ndian.activity.me.biz.MySellerOrderBiz;
...
public class MySellerOrderActivity extends AppCompatActivity {
    ...
    private MySellerOrderAdapter adapter;
            ...
            switch (msg.what){
                ...
                case Constants.FAILURE:
                    if(page==1){
                        ...
                        refreshListView.loading(false);
                        new ToastShow(MySellerOrderActivity.this,getResources().getString(R.string.No_more),1000);
                    }
                    refreshListView.onFinish(isRefreshOrLoading);
                    break;
                /**获取数据失败*/
                ...
                case Constants.USER_FAILURE:
                    //跳转到登录界面
                    new LoginOutUtil(MySellerOrderActivity.this);
                    finish();
                    break;
            }
        }
    ...
    private void setOnClick() {
        ...
        refreshListView.setOnRefreshListener(new MyRefreshListView.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                new MySellerOrderBiz(MySellerOrderActivity.this,handler,entityList,page);
            }
    ...
    private void InitView() {
        NdianApplication.instance.setTitle(this, getResources().getString(R.string.The_seller_of_the_order), true);
        ...
        animation=new LoadingAnimation(MySellerOrderActivity.this,loadingInclude);
        Reconnection();
    }
    ...
    private void setData() {
        animation.startAnim();
        entityList=new ArrayList<>();
        adapter=new MySellerOrderAdapter(MySellerOrderActivity.this,entityList);
