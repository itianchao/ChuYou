 ...
 */
public class MyBuyersOrderBiz implements HttpListener<String> {
    private Request mRequest;
    private Handler handler;
    private ArrayList<CommodityEntity> entityList;
    public MyBuyersOrderBiz(Context context, Handler handler, ArrayList<CommodityEntity> entityList, int page){
        this.entityList=entityList;
        this.handler=handler;
        RequestMethod method = RequestMethod.POST;// 默认get请求
        mRequest=  NoHttp.createStringRequest(Constants.ORDERS_LIST, method);
