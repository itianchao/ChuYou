...
import com.jueda.ndian.activity.home.biz.TaskActivityListBiz;
 ...
 * 活动
 */
public class TaskActivity_Fragment extends LazyFragment {
    public static TaskActivity_Fragment instance=null;
    public static String TAG=TaskActivity_Fragment.class.getName();
    // 标志位，标志已经初始化完成。
            ...
            switch (msg.what){
                ...
                case Constants.FAILURE_TWO:
                    if(page==1){
                        ...
                        animation.stopAnim();
                        if(TaskActivity_Fragment.this.isAdded()) {
    ...
    public void loadData(){
            new TaskActivityListBiz(getActivity(), handler, taskCommonEntities, cid(), page);
    }
