...
import com.jueda.ndian.activity.me.adapter.MyTaskAuditAdapter;
 ...
 */
public class MyTask_AuditFragment  extends Fragment {
    private View view;
    ...
    private MyTaskAuditAdapter adapter;
            ...
            switch (msg.what){
                ...
                case Constants.FAILURE:
                    if(page==1){
                        ...
                        animation.stopAnim();
                        if(MyTask_AuditFragment.this.isAdded()) {
                ...
                case Constants.USER_FAILURE:
                    //跳转到登录界面
                    new Configuration().writeaIsLogin(getActivity(),false);
    ...
    private void setOnClick() {
        ...
        list.setOnRefreshListener(new MyRefreshListView.OnRefreshListener() {
            ...
            public void onLoadMore() {
                ...
                ++page;
                new MyTaskAuditBiz(getActivity(),handler,1,page,entityList);
            }
        });
    }
    /**
    ...
    private void setData() {
        ...
        adapter=new MyTaskAuditAdapter(getActivity(),entityList);
