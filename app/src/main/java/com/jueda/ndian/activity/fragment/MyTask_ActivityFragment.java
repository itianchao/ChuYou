...
import com.jueda.ndian.activity.me.biz.MyTaskActivityBiz;
 ...
 * 我的任务，发布活动
 */
public class MyTask_ActivityFragment extends LazyFragment{
    public static final String TAG=MyTask_ActivityFragment.class.getName();
    public static MyTask_ActivityFragment instance=null;
    private View view;
    // 标志位，标志已经初始化完成。
    ...
    private void setOnClick() {
        ...
        list.setOnRefreshListener(new MyRefreshListView.OnRefreshListener() {
            ...
            public void onLoadMore() {
                ...
                ++page;
                new MyTaskActivityBiz(getActivity(), handler, page, entityList);
            }
        });
    }
    /**
