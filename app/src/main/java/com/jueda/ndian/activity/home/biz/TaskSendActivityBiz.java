 ...
 * 发布活动
 */
public class TaskSendActivityBiz  implements HttpListener<String> {
    private Request mRequest;
    private Handler handler;
    private Activity context;
    public  TaskSendActivityBiz(Activity context, Handler handler, String cid, String reward, String descript, String content, String title, String number, String[] img_arr){
        ...
        mRequest=  NoHttp.createStringRequest(Constants.TASK_SEND_ACTIVITY, method);
        mRequest.add("user_token", ConstantsUser.userEntity.getUserToken());
        mRequest.add("reward",reward);
        mRequest.add("descript",descript);
