 ...
 * 我的审核未通过任务
 */
public class MyTaskAudit_UnAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<AppEntity> entityList;

    public MyTaskAudit_UnAdapter(Context context, ArrayList<AppEntity> entityList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder1 holder1;
        if(convertView==null){
                    convertView=View.inflate(context, R.layout.item_my_task_audit_un_list,null);
                    ...
                    holder1.why=(TextView)convertView.findViewById(R.id.why);
        ...
        holder1.why.setText("驳回原因："+entityList.get(position).getReason());
