 ...
 */
public class MyTask_CompleteFragment  extends LazyFragment {
    private View view;
    // 标志位，标志已经初始化完成。
            ...
            switch (msg.what){
                ...
                case Constants.FAILURE:
                    if(page==1){
                        ...
                        animation.stopAnim();
                        if(MyTask_CompleteFragment.this.isAdded()) {
    ...
    private void setOnClick() {
        ...
        list.setOnRefreshListener(new MyRefreshListView.OnRefreshListener() {
            ...
            public void onLoadMore() {
                ...
                ++page;
                new MyTaskAuditBiz(getActivity(), handler, 2, page, entityList);
            }
        });
    }
    /**
