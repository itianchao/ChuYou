 ...
 * 圈内任务
 */
public class CircleAllTaskActivity extends AppCompatActivity implements View.OnClickListener{
    public static CircleAllTaskActivity instance=null;
    public static final String TAG=CircleAllTaskActivity.class.getName();
    ...
    private void InitView() {
        NdianApplication.instance.setTitle(this, getResources().getString(R.string.Hlep_Ring_Main_task), true);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            //发任务
            case R.id.send_task:
                if(new Configuration().readaIsLogin(CircleAllTaskActivity.this)) {
                    Intent intent = new Intent(CircleAllTaskActivity.this, TaskReleaseActivity.class);
                    intent.putExtra("cid", getIntent().getStringExtra("cid"));
                    startActivity(intent);
                }else{
                    startActivity(new Intent(CircleAllTaskActivity.this, LoginActivity.class));
                }
                break;
            //体验
