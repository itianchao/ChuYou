...
public class UserTopicAdapter extends BaseAdapter{
    ...
    public UserTopicAdapter(Activity context, ArrayList<TopicEntity> entityList, int screenWidth) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=View.inflate(context, R.layout.item_topic_list_user,null);
...
//        holder.NameTextView.setText(entityList.get(position).getName());
        ...
        setOnClickTOPIC(holder.thumbNumber, holder.lookParticulars,  position);
        return convertView;
    }
    /**
     * @param thumbNumber
     ...
     * @param position
     */
    private void setOnClickTOPIC(final RadioButton thumbNumber, final LinearLayout lookParticulars, final int position) {
        /**查看话题详情*/
