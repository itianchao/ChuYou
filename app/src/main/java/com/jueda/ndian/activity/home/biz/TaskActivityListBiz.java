 ...
 * 活动任务列表
 */
public class TaskActivityListBiz  implements HttpListener<String> {
    private Request mRequest;
    private Handler handler;
    private ArrayList<TaskCommonEntity> appEntityArrayList;
    public TaskActivityListBiz(Context context, Handler handler, ArrayList<TaskCommonEntity> appEntityArrayList,String cid, int page){
        this.handler=handler;
        this.appEntityArrayList=appEntityArrayList;
        RequestMethod method = RequestMethod.POST;// 默认get请求
        mRequest=  NoHttp.createStringRequest(Constants.TASK_ACTIVITY_LIST, method);
        mRequest.add("p",page);
